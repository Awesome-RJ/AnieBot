...
from AnieBot import BOT_ID, MONGO_DB_URI, OWNER_ID, tbot
from AnieBot.modules.sql.chats_sql import add_chat, is_chat
...
def generate_captcha():
    ...
    height = 100
    correct_answer = ""
    font = ImageFont.truetype("./AnieBot/modules/sql/DroidSans.ttf", 55)
