...
@Abot(pattern="^/start(@DecodeManagerBot)?$")
async def start(e):
...
Our privacy policy may change from time to time. If we make any material changes to our policies, we will place a prominent notice on https://t.me/AnieBotChan_Updates.
"""
    b = [
